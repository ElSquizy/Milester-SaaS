...
export default async function TemplatesPage() {
  const [templates, imageTemplates, productTemplates, categories] = await Promise.all([
  ...
  return <TemplatesClient templates={list} imageTemplates={imgList} productTemplates={productTemplates} categories={categoryList} categoryTree={categoryTree} />;
}
