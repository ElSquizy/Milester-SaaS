...
export default async function TemplatesPage() {
  ...
  const imgList = imageTemplates.map((t) => ({ id: t.id, name: t.name, backgroundUrl: t.backgroundUrl, coverUrl: t.coverUrl, productX: t.productX, productY: t.productY, productW: t.productW, productH: t.productH, cropLateral: t.cropLateral, shadowOffsetX: t.shadowOffsetX, shadowOffsetY: t.shadowOffsetY, shadowBlur: t.shadowBlur, shadowOpacity: t.shadowOpacity, productCount: t._count.products }));
